...
if grade == 1:
    ...
    show_pdf_download("허가신청서", "pdf/[별지 제3호서식] 의료기기 제조(수입) 허가신청서(의료기기법 시행규칙).pdf")
    show_pdf_download("인증신청서", "pdf/[별지 제5호서식] 의료기기 제조(수입) 인증신청서(의료기기법 시행규칙).pdf")
    show_pdf_download("신고서", "pdf/[별지 제7호서식] 의료기기 제조(수입) 신고서(의료기기법 시행규칙).pdf")
else:
    st.success("제출 서류:")
    st.markdown("- 인증신청서\n- GMP 적합인정서\n- 기술문서")
    st.divider()
